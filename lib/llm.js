 ...
 * @param {string[]} region
 */
export async function storeFeatures(feature, description, isCompliant) {
  try {
    if (!feature || !description || !isCompliant) {
      throw new Error(
        "All three fields (feature, description, isCompliant) are required."
      );
    }
