...
def law_text_to_json(text, kb_title="Reporting_requirements_of_providers"):
    ...
    for line in text.splitlines():
        ...
        if m:
            ...
            section_number = "Section " + m.group(1)
...
if __name__ == "__main__":
    # Replace with your actual law text (from PDF extract)
    text = """(a)Duty To Report.—
(1)In general.—
...
The facts or circumstances described in this subparagraph are any facts or circumstances from which there is an apparent violation of section 2251, 2251A, 2252, 2252A, 2252B, or 2260 that involves child pornography, of section 1591 (if the violation involves a minor), or of [1] 2422(b).
...
(Added Pub. L. 110–401, title V, § 501(a), Oct. 13, 2008, 122 Stat. 4243; amended Pub. L. 115–395, § 2, Dec. 21, 2018, 132 Stat. 5287; Pub. L. 118–59, §§ 3, 4(a), May 7, 2024, 138 Stat. 1016.)"""  # your long law text here
    ...
    print(f"✅ Extracted {len(results)} entries → {output_path}")
